...
#include <stdlib.h>
#include <string.h>
#define CLEAR printf("\033[0;0H\033[2J"); //Ojo esto deberia limpiar la pantalla
...
printf("paso 1 ⁄n");
printf("pointer 1 vive en %p, apunta a %p, que contiene%d\n", (void*)&pointr_1, (void*)pointr_1,*pointr_1);
printf("El valor actual de la variable es de %d\n",variable1);


int*pointr_2=&variable1;
*pointr_2=*pointr_2*2;

printf("paso 2⁄n");
printf("pointer 2 vive en %p, apunta a %p, que contiene %d\n", (void*)&pointr_2, (void*)pointr_2,*pointr_2);
printf("el valor actual de la variable es de %dºn", variable1);



int*pointr_3=&variable1;
*pointr_3=*pointr_3+5;

printf("paso 3⁄n");
printf("pointer 3 vive en %p, apunta a %p, que contiene %d\n", (void*)&pointr_3, (void*)pointr_3, *pointr_3);
printf("La variable vale %d",variable1);
